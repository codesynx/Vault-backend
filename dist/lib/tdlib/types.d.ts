...
export type AuthorizationState = 'authorizationStateWaitTdlibParameters' | 'authorizationStateWaitPhoneNumber' | 'authorizationStateWaitCode' | 'authorizationStateWaitPassword' | 'authorizationStateReady' | 'authorizationStateLoggingOut' | 'authorizationStateClosing' | 'authorizationStateClosed';
